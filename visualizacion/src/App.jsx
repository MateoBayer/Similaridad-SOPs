...
function App() {
  return (
    <div className="app">
      ...
      {/*
      <section className='sentence-transformer'>
        <h2>Sentence Tranformer</h2>
        <Graph file={'/X2_data_con_autores.csv'} />
        <DocumentComparison file={'/documents_similarity.csv'} />
        <Table file={'/documents_similarity.csv'} />
      </section>
      */}
    </div>
  );
